package com.indri.intentparceleble;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Indri Apriliani");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 16);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Indri Apriliani");
                mPerson.setAge(16);
                mPerson.setEmail("aprilianiindri25994.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "081541558798";
